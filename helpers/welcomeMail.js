export default function welcomeMail(name = "", loginLink) {
  ...
  <html lang="en" dir="ltr">
      <head>
          <meta charset="UTF-8" />
          <title>Welcome to Elizabeth Ryle Wealth Management</title>
          <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
          <meta content="Elizabeth Ryle Wealth Management" name="description" />
          <meta name="author" content="Elizabeth Ryle Wealth Management" />
                  ...
                  <tbody>
                      <tr>
                          <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                              Welcome to Elizabeth Ryle Wealth Management, ${name}
                          </td>
                      </tr>
                      <tr>
                          <td style="padding: 15px 24px 15px; color: #676d74;">
                              Thanks for creating an account with Elizabeth Ryle Wealth Management. To continue, please login and perform the needed verification by submitting a valid I.D
                          </td>
                      </tr>
                      ...
                      <tr>
                          <td style="padding: 15px 24px 15px; color: #676d74;">
                              Elizabeth Ryle Wealth Management <br> Support Team
                          </td>
                      </tr>
      
                      <tr>
                          <td style="padding: 16px 8px; color: #676d74; background-color: #f8f9fc; text-align: center;">
                              © <script>document.write(new Date().getFullYear())</script> Elizabeth Ryle Wealth Management.
                          </td>
                      </tr>
                  </tbody>
              </table>
